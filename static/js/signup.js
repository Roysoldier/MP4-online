function sign_up() {
    ...
    if (pseudo.lengt > 12){
        document.getElementById('errormessage').innerHTML = 'Maximum 12 caractères'
    ...
    if (!email.match(/^\w.+@[a-zA-Z_-]+?\.[a-zA-Z]{2,3}$/)){
        document.getElementById('errormessage1').innerHTML = "L'adresse e-mail est invalide"
    }
    else{
    ...
    if (passwordv != password){
        document.getElementById('errormessage3').innerHTML = 'Les mots de passes ne correspondent pas !'
    }
    else{
                ...
                success: function (result) {
                    ...
                    if (result.status == "ok") {
                        ...
                        if (result.msg == 'email already exists'){
                            document.getElementById('errormessage1').innerHTML = 'Adresse e-mail déja existante !'
                        }
                        else{
                            document.getElementById('errormessage1').innerHTML = ''
                        }
